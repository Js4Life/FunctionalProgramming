...
export class AuthenticationService extends BaseHttpService {
    ...
    private authUrl1 : string = environment.BASE_URL + "signIn/";
   ...
   login(obj) : Promise<boolean> {
        this.authUrl=this.authUrl1+obj.name+"/"+obj.password;
    // this.authUrl="http://stagingapi.fusehit.com/roles"
      return this.invokeService(this.authUrl,'',HttpVerbs.GET)
        .then(data => {
            console.log(data);
