...
export class ClientState{
    ...
    //     {id:'13:116', name:'PurchasedFinancialAssetswithCreditDeterioration', color:'#f6e365'},
    //     {id:'16:279', name:'Collateral', color:'#8591ca'},
    //     {id:'9:45', name:'Measurement Basis for CreditLosses', color:'#915996'},
    //     {id:'9:167', name:'Financial Instruments-Credit Losses', color:'#218e94'},
    //     {id:'12:157', name:'Disclosures', color:'#565461'},
    //     {id:'10:48', name:'AMEX Contexts', color:'#00ffff'},
    //     {id:'11:36', name:'Qualitative Overlay', color:'#80ff80'},
    //     {id:'13:289', name:'Definition Of Default', color:'#cc00cc'},
    //     {id:'12:362', name:'Information Considerations', color:'#8c8cd9'},
    //     {id:'16:20', name:'Operational and Governance', color:'#75a3a3'},
    //     {id:'16:45', name:'Staging (IFRS 9 Only)', color:'#ffa64d'},
    //     {id:'14:361', name:'TroubledDebtRestructuring', color:'#ff5500'},
    //     {id:'14:357', name:'LifeofLoan', color:'#218e94'},
    //     {id:'11:274', name:'CECL Effective Date', color:'#663300'},
    //     {id:'11:399', name:'Loan Commitments', color:'#c3c388'},
    //     {id:'9:49', name:'Segmentation', color:'#330033'},
    //     {id:'12:170', name:'LoanCommitment', color:'#ddffcc'},
    //     {id:'12:386', name:'Execution Frequency', color:'#8080ff'},
    //     {id:'14:316', name:'Disclosure', color:'#0000b3'},
    //     {id:'12:314', name:'TimeValueofMoney', color:'#66ffff'},
    //     {id:'13:152', name:'ScopingandRegulation', color:'#66ffd9'},
    //     {id:'9:0', name:'RootNode', color:'#993333'},
    //     {id:'9:147', name:'Forward Looking Information', color:'#ff80ff'},
    //     {id:'12:193', name:'Modeling Methodology', color:'#808080'},
    //     {id:'14:127', name:'OperationsandGovernance', color:'#ff1a1a'}
    //   ];
